...
FUNCTION (GetPlatformBinName PLATFORM_BIN_NAME LIBPATH_SUFFIX)
	...
	ELSEIF(TARGET_BUILD_PLATFORM STREQUAL "linux")
		...
		ENDIF()
	ELSEIF(TARGET_BUILD_PLATFORM STREQUAL "jni_linux")
		SET(RETVAL "jni.linux")
	ELSEIF(TARGET_BUILD_PLATFORM STREQUAL "jni_windows")
		SET(RETVAL "jni.win64")
	ELSEIF(TARGET_BUILD_PLATFORM STREQUAL "jni_mac64")
		SET(RETVAL "jni.mac64")
	ENDIF()
